 ...
 */
public abstract class SingleMeasurementBinding<Q1 extends Quantity<Q1,U1,M1>, U1 extends Unit<Q1,U1,M1>, M1 extends Measurement<Q1,U1,M1>, Q2 extends Quantity<Q2,U2,M2>, U2 extends Unit<Q2,U2,M2>, M2 extends Measurement<Q2,U2,M2>> extends MeasurementBinding<Q2,U2,M2> {

    private final ObservableValue<M1> observableMeasurement;

    public SingleMeasurementBinding(ObservableValue<M1> observableMeasurement, Observable... observables) {
