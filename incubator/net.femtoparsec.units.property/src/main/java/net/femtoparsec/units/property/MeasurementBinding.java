 ...
 */
public abstract class MeasurementBinding<Q extends Quantity<Q,U,M>, U extends Unit<Q,U,M>,M extends Measurement<Q,U,M>> extends MeasurementExpression<Q,U,M> implements Binding<M> {
     ...
     */
    protected abstract M computeValue();
    ...
    public String toString() {
        return valid ? "Measurement Binding [value: " + get() + "]"
                : "Measurement Binding [invalid]";
    }
